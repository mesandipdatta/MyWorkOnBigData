...
# "Twitter Text","Account Id","Name","Geo Location","Time of tweet","Language","Topic"
# 
# Author - Sandip Datta 
...
# Change ====================================================================================================
soup = BeautifulSoup(open("emc_dell_jan.html"),"lxml")
product_name = "EMC_Dell_Merger"
...
# Change ================================================================================================
writer.writerow(["Twitter Text","Account Id","Name","Geo Location","Time of tweet","Language","Topic"])
